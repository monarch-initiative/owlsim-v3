...
/**
 * Performance test for NaiveBayesFixedWeightThreeStateProfileMatcher using full HPO and HPO annotations,
...
public class NaiveBayesianFixedWeightTwoStateMatcherPerfIT extends AbstractProfileMatcherTest {
	...
	public void testQueryWithSelf() throws Exception {
		...
		eval.writeJsonTo("target/naivebfw3-it-results-sjs.json");
