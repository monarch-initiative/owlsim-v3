...
import org.monarchinitiative.owlsim.compute.matcher.impl.cosine.CosineSimilarityProfileMatcher;
import org.monarchinitiative.owlsim.kb.BMKnowledgeBase;

public class CosineSimilarityProfileMatcherMPTest extends AbstractProfileMatcherMPTest {

	protected ProfileMatcher createProfileMatcher(BMKnowledgeBase kb) {
		return CosineSimilarityProfileMatcher.create(kb);
	}
